...
# Data 
laps<-read.csv("DryQuickLaps.csv")
circuitInfo<-read.csv("CircuitInfo.csv")
stints<-read.csv("Stints.csv")
pitstops<-read.csv("PitstopsWithTeams.csv")
outlaps<-read.csv("Outlaps.csv")
inlaps<-read.csv("Inlaps.csv")
nlaps<-read.csv("NLaps.csv")
safetycars<-read.csv("SafetyCars.csv")
strategy<-read.csv("Strategyfull.csv")
